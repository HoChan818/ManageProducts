sap.ui.define([
	"sap/ui/test/Opa5",
	"manage_products/ManageProducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("manage_products.ManageProducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "manage_products.ManageProducts",
					async: true
				},
				hash: oOptions.hash,
